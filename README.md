...
The controller renders nothing itself. The image below shows the effect: the same companion widget (Memory) themed by the controller under each of the four schemes.
